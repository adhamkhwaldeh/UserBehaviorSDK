...
// Apply Dokka plugin to all subprojects
//subprojects {
...
//            includes.from(project.file("UserBehaviorSDK/IntegrationGuide.md"))
//
...
////            remoteUrl.convention(URL("https://github.com/adhamkhwaldeh/UserBehaviorSDK/tree/main/app/src/main/java"))
