...
fun SensorScreen(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        // Conditionally apply the modifier to collect touch events.
        // This is more efficient as the manager is only created and started when needed.
        val touchModifier = if (isViewTouchEnabled) {
            Modifier.collectViewTouchEvents { result ->
        ...
        Box(
            modifier = Modifier
                ...
                .then(touchModifier) // Chain the conditional modifier
        )
